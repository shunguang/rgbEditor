...
if (!myFile.is_open()) {
dumpLog("RawFrmFileIo::saveRawFrms(): cannot open file: %s", filePath.c_str());
return false;
}
...
if (!myFile.is_open()) {
dumpLog("RawFrmFileIo::loadRawFrms(): cannot open file: %s", filePath.c_str());
return false;
}
...
ofstream myFile(filePath, ios::out | ios::binary);
if (!myFile.is_open()) {
dumpLog("RawFrmFileIo::saveFrmIdxQ(): cannot open file: %s", filePath.c_str());
return false;
}
...
ifstream myFile(filePath, ios::in | ios::binary);
if (!myFile.is_open()) {
dumpLog("RawFrmFileIo::loadFrmIdxQ(): cannot open file: %s", filePath.c_str());
return false;
}
