...
CfgCombineInput::CfgCombineInput()
	: CfgInput(APP_TOOLBAR_COMBINE)
	, inputVideoFolder("")
...
void CfgCombineInput::fromPropertyTree(const boost::property_tree::ptree &pt)
{
...
boost::property_tree::ptree CfgCombineInput::toPropertyTree()
{
