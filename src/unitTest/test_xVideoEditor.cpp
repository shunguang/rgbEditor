...
int test_xVideoEditor(int argc, char **argv)
{
	...
	startLogThread(logFile, cfg->m_log.isShowLogInConsole, true);
	...
	dumpLog("update current cfg file: " + cfgAutoCutFile);
...
std::string locateCfgFile(const std::string &f0)
{
	...
	//developing folder
	string cfgFile2 = "C:/Projects/xVideoEditor/src/unitTest/res/" + f0;
