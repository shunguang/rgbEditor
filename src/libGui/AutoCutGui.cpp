...
{
	//image Windows
	groupBox_imgWin = new QGroupBox(m_centralWidget);
	...
	//log group box
	if (m_isShowDebugMsg) {
		groupBox_log = new QGroupBox(m_centralWidget);
...
{
	groupBox_browseVideo = new QGroupBox(m_centralWidget);
...
{
	groupBox_gameInfo = new QGroupBox(m_centralWidget);
...
{
	groupBox_output = new QGroupBox(m_centralWidget);
...
{
	groupBox_param = new QGroupBox(m_centralWidget);
...
{
	//buttons group box
	groupBox_cmdButtons = new QGroupBox(m_centralWidget);
...
{
	groupBox_progress = new QGroupBox(m_centralWidget);
