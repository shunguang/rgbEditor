...
bool app::mkDumDirs( const string &inSeqFileName, const string &dumpPathRoot, string &dumpPath4Debug, string &dumpPath4Customer )
{
...
void app::myCreateDir(const std::string &p)
{
