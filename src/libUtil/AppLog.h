...
namespace app {
	...
	void  UTIL_EXPORT appExit(const int flag);
	void  UTIL_EXPORT appExit(const char * x, ...);
	void  UTIL_EXPORT appExit(const  std::string &x, ...);
	void  UTIL_EXPORT appAssert(const bool flag, const std::string &msg);
	void  UTIL_EXPORT appAssert(const bool flag, const char *file, const int lineNum);
