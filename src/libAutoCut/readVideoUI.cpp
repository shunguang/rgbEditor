...
void app::getVideoInfo(const char *filePath, MyVideoStreamInfo &vInfo, MyAudioStreamInfo	&aInfo)
{
...
void app::readVideo(const char *filePath, const bool readVideo, const bool readAudio, int &vdieoFrmW, int &vdieoFrmH, std::vector<RawFrmPtr> &vFrm, std::vector<RawFrmPtr> &aFrm)
{
bool isRefCount = false;
CfgDemuxingDecodingPtr  cfg (new CfgDemuxingDecoding() );
cfg->demuxingVideo = 1;
