...
dumpLog("LocateHotSegsToCutVideo::saveHotSegsToWav() index out of range!");
continue;
}
...
//---------- gloabl funcs ------------------
void app::hotSegVec_print(const std::vector<HotSeg> &v, const std::string &msg)
{
printf("%s\n", msg.c_str());
...
void app::hotSegVec_sort(std::vector<HotSeg> &v)
{
#if _DEBUG
