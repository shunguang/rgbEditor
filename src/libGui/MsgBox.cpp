...
//always on top, non-auto close, block other application on GUI until <OK> is pressed
void app::popupMsg(QWidget *parent, const std::string &winTitle, const std::string &msg, const QMessageBox::Icon myIcon)
{
...
void app::popupInfoMsg(const std::string &winTitle, const std::string &msg, const uint32 timeout_ms, QRect *placeRect)
{
