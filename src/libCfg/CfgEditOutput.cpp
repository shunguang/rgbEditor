...
using namespace app;
using namespace std;
CfgEditOutput::CfgEditOutput()
	: CfgOutput(APP_TOOLBAR_EDIT)
{}
...
boost::property_tree::ptree CfgEditOutput::toPropertyTree()
{
	boost::property_tree::ptree pt;
	return pt;
}

void CfgEditOutput::fromPropertyTree(const boost::property_tree::ptree &pt)
{
#if 0
...
void CfgEditOutput::genOutputVideoInfo()
{
}
