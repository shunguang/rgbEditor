...
photoH = photoW;
if (photoW < 0) {
dumpLog("ImgRender::getTeamImgs(): photoW cannot be negative, which means imag size <m_w,m_h> is set too small!");
return -1;
}
...
dumpLog("ImgRender::getTeamImgs(): photoH is too small, messed up!");
}
